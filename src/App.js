...
const about =
`사람을 좋아하고, 배우기 좋아하는 신입 서버 개발자입니다. 인천하늘고등학교를 졸업했고, 서울대학교 컴퓨터공학부 19학번으로 재학중입니다. 과내 개발동아리 와플스튜디오에서 Server, Frontend developer로 활동 중이며, 여러가지 간단한 웹 애플리케이션을 제작한 경험이 있습니다.
많은 사람들이 즐겁게 사용하는 서비스를 만들어보고 싶습니다.
올해 1학기를 마치고, 여름부터 산업기능요원 현역 Server 개발자로 복무할 회사를 찾고 있습니다.
`
